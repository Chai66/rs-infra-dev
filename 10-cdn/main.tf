resource "aws_cloudfront_distribution" "devopspractice123" {
  ...
  origin {
    domain_name = "web-${var.environment}.${var.zone_name}"  # orgin domain = web-dev.devopspractice.online
  ...
  ordered_cache_behavior {
    ...
    target_origin_id = "web-${var.environment}.${var.zone_name}" # Whatever provided in origin_id need to be here
